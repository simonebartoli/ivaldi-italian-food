...
const Confirmation = () => {
    ...
    return (
        <main ref={fullPageRef} className="w-full flex flex-col items-center justify-center p-8">
            <div className="mb-12">
                <Image alt="Confirmation Icon" src={ConfirmImage}/>
            </div>
            <h1 className="leading-[4rem] text-center text-5xl text-green-standard font-semibold mb-16">Your Order Has Been Received</h1>
            <span className="leading-[3rem] text-2xl mb-12 text-center">We are happy to say that your order has been received 🎉</span>
