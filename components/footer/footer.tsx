...
const Footer = () => {
    ...
    return (
        <footer ref={footerRef} className="border-t-8 border-green-standard flex flex-row w-full smx:px-16 px-8 py-8 bg-[rgb(245, 245, 245)] mdx:justify-between justify-center items-center bg-white flex-wrap sm:gap-8 gap-12">
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <div>
                        <ul className="list-disc list-inside space-y-4">
                            ...
                            <Link href={"/receipts"}>
                                <li className="pl-2"><span className="pl-2">My Receipts</span></li>
                            </Link>
                        </ul>
                    </div>
                </div>
                <div className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex flex-row gap-4 items-center">
                            ...
                            <a href="tel:+447743192857">+44 77 4319 2857</a>
                        </div>
                        <div className="flex flex-row gap-4 items-center">
